...
try:
	if os.path.isfile(sys.argv[1]):
		...
		print ("")
		os.system("clamscan --follow-dir-symlinks=0 --follow-file-symlinks=0 -r '"+sys.argv[1]+"' --move="+clamToolsqtn+" --database="+clamToolsdb)
		print ("")
...
while MainMenu <= 2:
	...
	print ("   * Extra parameters: -r --follow-dir/file-symlinks=0")
	print ("")
	print (" - Info -")
	print ("")
 ...
 #Options from InputMenu variable
	if InputMenu == "h" or InputMenu == "H":
		...
		print ("* Loading virus database...")
		print ("")
		os.system("clamscan --follow-dir-symlinks=0 --follow-file-symlinks=0 -r '"+HomeUser+"' --move="+clamToolsqtn+" --database="+clamToolsdb+" --log="+clamToolslogs+"home-scan-["+CurrentDate+"]-["+CurrentTime+"].log")
		print ("")
		PauseReturn=input("+ Press ENTER to return ")
		...
		print ("* Loading virus database...")
		print ("")
		os.system("clamscan --follow-dir-symlinks=0 --follow-file-symlinks=0 -r '"+ForFtoScan+"' --move="+clamToolsqtn+" --database="+clamToolsdb+" --log="+clamToolslogs+"custom-scan-["+CurrentDate+"]-["+CurrentTime+"].log")
		print ("")
		PauseReturn=input("+ Press ENTER to return ")
		...
		print ("* Loading virus database...")
		print ("")
		os.system("clamscan --follow-dir-symlinks=0 --follow-file-symlinks=0 -r '"+SystemUser+"' --move="+clamToolsqtn+" --database="+clamToolsdb+" --log="+clamToolslogs+"system-scan-["+CurrentDate+"]-["+CurrentTime+"].log")
		print ("")
		PauseReturn=input("+ Press ENTER to return ")
